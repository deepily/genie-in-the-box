...
class GenieCmdClient:
    ...
    def get_transcription( self ):
        ...
        return genie_gui.genie_client.get_from_clipboard()
...
if __name__ == "__main__":
    ...
    recording_timeout        = int( cli_args.get( "recording_timeout", 10 ) )
    ...
    if debug: print( "     default_mode: [{}]".format( default_mode ) )
